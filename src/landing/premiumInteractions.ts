...
export function mountPremiumLanding({
  ...
  function applyLanguage(lang: string) {
    ...
    if (currentLang === "pt") browserUrl.searchParams.delete("lang");
    else browserUrl.searchParams.set("lang", currentLang);

    const canonicalUrl = new URL("https://www.patroai.com/");
    if (currentLang !== "pt") canonicalUrl.searchParams.set("lang", currentLang);
  ...
  if (immersiveGate) {
    ...
    const audioPlaylist = [
      "/media/patroai-v37-landing-111hz.mp3",
